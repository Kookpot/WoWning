...
namespace WoWning.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(WoWUser user)
        {
        ...
        {
            return string.Format(AuthenticatorUriFormat, _urlEncoder.Encode("WoWning"), _urlEncoder.Encode(email), unformattedKey);
        }
    }
}